...
describe("VmService", () => {
  it("launches with only the launch template infrastructure settings and creates the Caddy route", async () => {
    ...
    const result = await service.create("vm-1", "terry-bobby-black", "user-1");
